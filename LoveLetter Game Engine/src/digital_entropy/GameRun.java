...
public class GameRun {
    ...
    public void startGame() {
        ...
        for(int i =0; i <numberOfPlayers;i++){
            System.out.println(Players[i].getWinNumber());
        }
    }
    ...
    public void drawStartingHand(){
        ...
        if(Players[3].isPlaying()){
            ...
            System.out.println(Players[0].getName()+" drew the "+Players[0].getInHand().getName()+" card.");
            ...
            Players[0].setInHand(Deck[1]);;
            System.out.println(Player0.getName()+" drew the "+Players[0].getInHand().getName()+" card.");
            Players[1].setInHand(Deck[2]);
            Players[2].setInHand(Deck[3]);
            roundNumber = 4;
        }else {
    ...
    public void playedCard(int card){
        switch(card){
            ...
            case 2:
                ...
                System.out.println(Players[currentPlayer].getName()+" is Playing a Priest and targeting "+Players[targetPlayer].getName());
                playPriest();
                break;
            case 3:
                do {
