...
public class MediumBot extends Player implements PlayerTurn {
    Random rand = new Random();

    public MediumBot(String name, int ID){
        super();
        this.name = name;
        playerType=1;
        setID(ID);
    ...
    public int getTurn(Player [] Players){
        ...
        if(getDrawnCard().getValue()==8){
            ...
            return 1;
        // if you know a player has a card and you have a guard target that player
        ...
        // if you have a baron and your other card is higher than 5 play baron
